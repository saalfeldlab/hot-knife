...
--lambdaModel 0.1 \
--maxEpsilon 20 \
--n5Input /groups/cosem/cosem/data/HeLa_Cell3_4x4x4nm/HeLa_Cell3_4x4x4nm_raw.n5 \
--n5Output /groups/cosem/cosem/saalfelds/HeLa_Cell3_4x4x4nm/HeLa_Cell3_4x4x4nm_raw.n5 \
--tmpPath /groups/cosem/cosem/saalfelds/HeLa_Cell3_4x4x4nm/tmp \
--distance 10 \
--minIntensity -5000 \
--maxIntensity 1000 \

...
DATASET="/cost/Sec03_20200206_162201"

#$HOME/spark/n5-spark/startup-scripts/spark-janelia/n5-downsample.py 10 -n "$N5" -i "$DATASET/s0" -o "$DATASET/s1" -b 128,128,128 -f 6,1,6

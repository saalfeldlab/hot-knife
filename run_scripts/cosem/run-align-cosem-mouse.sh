...
--lambdaModel 0.1 \
--maxEpsilon 20 \
--n5Input /groups/cosem/cosem/data/Mouse_NA3-3_4x4x4nm/Mouse_NA3-3_4x4x4nm_raw.n5 \
--n5Output /groups/cosem/cosem/saalfelds/Mouse_NA3-3_4x4x4nm/Mouse_NA3-3_4x4x4nm_raw.n5 \
--tmpPath /groups/cosem/cosem/saalfelds/Mouse_NA3-3_4x4x4nm/tmp \
--distance 10 \
--minIntensity 127 \
--maxIntensity 192 \

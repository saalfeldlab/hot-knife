...
--lambdaModel 0.1 \
--maxEpsilon 20 \
--n5Input /groups/cosem/cosem/data/HeLa_Cell1_8x8x8nm/HeLa_Cell1_8x8x8nm_raw.n5 \
--n5Output /groups/cosem/cosem/saalfelds/HeLa_Cell1_8x8x8nm/HeLa_Cell1_8x8x8nm_raw.n5 \
--tmpPath /groups/cosem/cosem/saalfelds/HeLa_Cell1_8x8x8nm/tmp \
--distance 10 \
--minIntensity 64 \
--maxIntensity 192 \

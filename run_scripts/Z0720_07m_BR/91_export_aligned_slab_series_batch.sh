...
# use --explainPlan option to output debug info without running export

# actual runs done with commit f296ed9f85a0bd59d0a31c77befcd7eb424a553f which had a bug that was fixed later
...
LOG_FILE=$(setupRunLog "export-aligned-slab-series")

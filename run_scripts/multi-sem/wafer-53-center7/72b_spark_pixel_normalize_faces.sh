...
SLAB_AND_SURFACE="${1}"
N_NODES="2"
NORMALIZE_METHOD="LOCAL_CONTRAST" # LOCAL_CONTRAST, CLAHE
...
if [[ "${NORMALIZE_METHOD}" == "LOCAL_CONTRAST" ]]; then
  NORMALIZED_SUFFIX="_local-inverted"
elif [[ "${NORMALIZE_METHOD}" == "CLAHE" ]]; then
  NORMALIZED_SUFFIX="_clahe-inverted"
else
...
SOURCE_DATASET="/flat/${SLAB_AND_SURFACE}/face"
...
LOG_DIR="logs/72b_normalize_faces"

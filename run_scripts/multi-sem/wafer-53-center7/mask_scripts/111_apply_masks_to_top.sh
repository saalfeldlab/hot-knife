...
# these run fast with a sufficient number of cores (10 minutes with 1 11-core worker for one stack)
# use < 60 minute limit to get on short queue with ~200 nodes
export RUNTIME="59"
...
LOG_DIR="logs/111_apply_masks_to_top"

package org.janelia.saalfeldlab.ispim.bdv;
/*-
 * #%L
...
import net.preibisch.mvrecon.fiji.spimdata.explorer.bdv.MonotoneCubicSpline;
...
public class BDVFlyThrough
{
	...
	public static void record( final ViewerPanel viewer )
	{

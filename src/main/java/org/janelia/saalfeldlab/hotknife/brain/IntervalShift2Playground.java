...
public class IntervalShift2Playground {
	...
	public static void main(String[] args) {
		...
		final FinalInterval interval = Intervals.createMinSize(710, 210, 1, 300);
		final double[] translation = {0, -50};
		final double[] weights = {100, 20};
		final RealTransform transformFromSource = new PlaneIntervalShift(0, interval, translation, weights);

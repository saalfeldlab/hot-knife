...
--lambdaModel 0.1 \
--maxEpsilon 20 \
--n5Input /groups/cosem/cosem/data/TWalther_WT45_Cell2_4x4x4nm/TWalther_WT45_Cell2_4x4x4nm_raw.n5 \
--n5Output /groups/cosem/cosem/saalfelds/TWalther_WT45_Cell2_4x4x4nm/TWalther_WT45_Cell2_4x4x4nm_raw.n5 \
--tmpPath /groups/cosem/cosem/saalfelds/TWalther_WT45_Cell2_4x4x4nm/tmp \
--distance 10 \
--minIntensity -5000 \
--maxIntensity -2000 \

...
--lambdaModel 0.1 \
--maxEpsilon 5 \
--n5Input /groups/cosem/cosem/data/Chlamydomonas_4x4x4nm/Chlamydomonas_4x4x4nm_raw.n5
--n5Output /groups/cosem/cosem/saalfelds/Chlamydomonas_4x4x4nm/Chlamydomonas_4x4x4nm_raw.n5
--tmpPath /groups/cosem/cosem/saalfelds/Chlamydomonas_4x4x4nm/tmp
--distance 10 \
--minIntensity 0 \
--maxIntensity 255 \
